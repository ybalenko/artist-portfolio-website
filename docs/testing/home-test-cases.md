...
- Shared navigation is exercised from Home and its linked routes. Portfolio is implemented; Contacts, Resume, and disabled Exhibitions suites remain open in M9.
